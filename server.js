...
const corsOptions = {
  origin: ["http://127.0.0.1:5500", "https://library-projects.vercel.app", "https://botchavarun.github.io/frontend/"],
...
mongoose.connect("mongodb+srv://varun:1234@cluster0.yllpes0.mongodb.net/main?retryWrites=true&w=majority&appName=Cluster0", { useNewUrlParser: true, useUnifiedTopology: true })
    .then(() => {
